...
Go to [the GitHub issue tracker](https://github.com/alces-flight/flight-diag/issues?state=open)
...
[GitHub issue tracker for Flight Diagnostics](https://github.com/alces-flight/flight-diag/issues/new)
to report the issue.
...
which can be [found
here](https://www.clahub.com/agreements/alces-flight/flight-diag). This
